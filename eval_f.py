...
# cim_ = np.load('/home/peth/Databases/rPascal/features/Queries/2008_001451.npy')
# cim_2 = np.load('/home/peth/Databases/rPascal/features/Queries/2008_004399.npy')
#
# pim = np.load('/home/peth/Databases/rPascal/features/Queries/2008_000783.npy')
# pim2 = np.load('/home/peth/Databases/rPascal/features/Queries/2008_000880.npy')
# dist = np.linalg.norm(pim - pim2)
# dist
in_ = np.array(im, dtype=np.float32)
#dst = dis.euclidean(cim_,in_)
in_ = in_[:, :, ::-1]
...
types = ['background', 'aeroplane', 'bicycle', 'bird', 'boat', 'bottle', 'bus', 'car', 'cat', 'chair', 'cow',
