...
class Dataset(object):
    ...
    def __init__(self, home_dir):
        ...
        #   print "ref", type(self.references)
        # print self.references
        self.queries = OrderedDict()
        # print "que", type(self.queries)
        # print self.queries
        self.annotations = defaultdict(dict)
        # print "anno", type(self.annotations)
        #   print "hey",self.annotations
        ...
        a = []
        r = OrderedDict()
        for i, j in enumerate(self.queries.keys()):
            a.append(j)
            #  print a
    ...
    for key in k:
        ...
        for element in value:
            ...
            if dist < min_dist:
                min_dist = dist
                min_y = str(element)
#        print "min_dist_of_key: " + str(key) + " <> " + min_y + " => dist: " + str(min_dist)
    # for e1 in k.keys():
    #     min_dist = 10000
    #     e2 = k[e1]
    #     x1 = ''
